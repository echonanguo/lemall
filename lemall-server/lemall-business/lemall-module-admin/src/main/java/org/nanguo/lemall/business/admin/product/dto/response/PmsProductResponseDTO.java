package org.nanguo.lemall.business.admin.product.dto.response;
...
@Getter
@Setter
@Schema(name = "商品信息响应dto")
public class PmsProductResponseDTO implements Serializable {
    @Serial
    ...
    @Schema(description = "画册图片，限制为5张，以逗号分割")
    ...
    @Schema(description = "促销类型：0->原价;1->促销价；2->会员价；3->阶梯价格；4->满减；5->限时购")
